...
export class DdbService {
  ...
  references: Record<string, { reference: string }> = {
    ...
    'medicaid|VA|97152': { reference: 'https://www.dmas.virginia.gov/media/6450/project-bravo-services-rates-01-01-2024.xlsx' },
    'medicaid|ID|97152': { reference: 'https://magellanofidaho.com/documents/2446693/3042025/IBHP_rates_op.pdf/3bb9b427-85ce-5cea-3f90-af13faeb88e4?t=1719347194487' },
    'medicaid|ID|97154': { reference: 'https://magellanofidaho.com/documents/2446693/3042025/IBHP_rates_op.pdf/3bb9b427-85ce-5cea-3f90-af13faeb88e4?t=1719347194487' },
    'medicaid|ME|97154': { reference: 'https://www.mass.gov/doc/rates-for-applied-behavior-analysis-effective-october-1-2024-0/download' },
    'medicaid|WA|97154': { reference: 'https://www.hca.wa.gov/assets/billers-and-providers/aba-20240101.xlsx' },
    'medicaid|ID|97157': { reference: 'https://magellanofidaho.com/documents/2446693/3042025/IBHP_rates_op.pdf/3bb9b427-85ce-5cea-3f90-af13faeb88e4?t=1719347194487' },
    'medicaid|VA|97157': { reference: 'https://www.dmas.virginia.gov/media/6450/project-bravo-services-rates-01-01-2024.xlsx' },
    'medicaid|WA|97158': { reference: 'https://www.hca.wa.gov/assets/billers-and-providers/aba-20240101.xlsx' },
    ...
    'medicaid|GA|00000': { reference: 'https://www.mmis.georgia.gov/portal/PubAccess.Provider%20Information/Fee%20Schedules/tabId/20/Default.aspx' },
    ...
    'medicaid|KY|00000': { reference: 'https://www.chfs.ky.gov/agencies/dms/DMSFeeRateSchedules/Copy%20of%202024%20Behavioral%20Health%20%20Fee%20Schedule_04012024%20FINAL%20updated%20032724.pdf' },
    ...
    'medicaid|MD|00000': { reference: 'https://health.maryland.gov/mmcp/longtermcare/Documents/ABA-Fee-Schedule-Eff-7.1.2024.pdf' },
    ...
    'medicaid|NJ|00000': { reference: 'https://test.njmmis.com/downloadDocuments/OperationalManual_2024.pdf' },
    ...
    'medicaid|SC|00000': { reference: 'https://ed.sc.gov/districts-schools/medicaid/fee-schedules/autism-spectrum-disorder-asd-fee-schedule/' },
    'medicaid|SD|00000': { reference: 'https://dss.sd.gov/Medicaid/providers/feeschedules/default.aspx#:~:text=The%20Medicaid%20fee%20schedules%20listed%20below%20are,and%20customary%20charges%20for%20services%20rendered%20to' },
    ...
    'medicaid|WI|00000': { reference: 'https://www.forwardhealth.wi.gov/MaxFee/behav_max_fee_20250901.csv' },
    'medicaid|WV|00000': { reference: 'https://peia.wv.gov/Forms-Downloads/Documents/peia_policies/Applied%20Behavior%20Analysis%20Fee%20Schedule%207012022.pdf' },
